...
export const zh = {
  ...
  commit: '提交',
  commitError: '提交失败',
  commitPushed: '已提交并推送到 GitHub',
  commitLocalOnly: '已提交（本地），推送失败：',
  branch: '分支',
  ...
  uploading: '上传中…',
  uploadFailed: '上传失败',
  uploadOverwriteTitle: '文件已存在',
  uploadOverwriteDesc: '「{name}」已存在，点击「覆盖」将替换原文件。',
  uploadOverwrite: '覆盖',
  dropToUpload: '松开即可上传到该文件夹',
  delete: '删除',
  deleteTitle: '删除',
  deleteFileDesc: '确定要删除文件「{name}」吗？此操作不可恢复。',
  deleteDirDesc: '确定要删除目录「{name}」及其全部内容吗？此操作不可恢复。',
  deleteFailed: '删除失败',
  settingsNav: '侧边卡片',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  commitPushed: 'Committed and pushed to GitHub',
  commitLocalOnly: 'Committed locally; push failed: ',
  branch: 'Branch',
  ...
  uploadOverwriteTitle: 'File exists',
  uploadOverwriteDesc: '"{name}" already exists. Click Overwrite to replace it.',
  uploadOverwrite: 'Overwrite',
  dropToUpload: 'Drop to upload into this folder',
  delete: 'Delete',
  deleteTitle: 'Delete',
  deleteFileDesc: 'Delete file "{name}"? This cannot be undone.',
  deleteDirDesc: 'Delete directory "{name}" and all of its contents? This cannot be undone.',
